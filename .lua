-- Razor UI Library V2
-- Full rewrite for absolute visual fidelity and bug fixes
...
local library = {
    ...
    theme = {
        ...
        inner_border = Color3.fromRGB(25, 25, 25),
...
function library:CreateWindow(name, size, keybind)
    ...
    -- Triple Border Style
    local border1 = Instance.new("Frame", mainFrame)
    border1.Size = UDim2.new(1, 2, 1, 2)
    border1.Position = UDim2.fromOffset(-1, -1)
    border1.BackgroundTransparency = 1
    border1.BorderSizePixel = 1
    border1.BorderColor3 = Color3.fromRGB(0, 0, 0)
    border1.ZIndex = 0

    local border2 = Instance.new("Frame", mainFrame)
    border2.Size = UDim2.new(1, 4, 1, 4)
    border2.Position = UDim2.fromOffset(-2, -2)
    border2.BackgroundTransparency = 1
    border2.BorderSizePixel = 1
    border2.BorderColor3 = library.theme.border
    border2.ZIndex = -1
    ...
    contentArea.Position = UDim2.fromOffset(10, 60)
    ...
    function window:CreateTab(tabName)
        ...
        leftLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
            left.CanvasSize = UDim2.new(0,0,0,leftLayout.AbsoluteContentSize.Y + 5)
        end)
        ...
        rightLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
            right.CanvasSize = UDim2.new(0,0,0,rightLayout.AbsoluteContentSize.Y + 5)
        end)

        function tab:Select()
            for _, t in pairs(window.tabs) do
                t.frame.Visible = false
                t.btn.TextColor3 = library.theme.text_dark
                t.indicator.Visible = false
            end
            frame.Visible = true
            btn.TextColor3 = library.theme.text_active
        ...
        function tab:CreateSector(name, side)
            ...
            sFrame.BackgroundColor3 = library.theme.background
            sFrame.BorderSizePixel = 1
            sFrame.BorderColor3 = library.theme.border
            sFrame.ZIndex = 5

            local sTitle = Instance.new("TextLabel", sFrame)
            sTitle.Text = " " .. name .. " "
            sTitle.Size = UDim2.fromOffset(textservice:GetTextSize(sTitle.Text, 12, library.theme.font, Vector2.new(200,20)).X, 15)
            sTitle.Position = UDim2.fromOffset(10, -8)
            sTitle.BackgroundColor3 = library.theme.background
            ...
            container.Size = UDim2.new(1, -16, 1, -15)
            container.Position = UDim2.fromOffset(8, 10)
            container.BackgroundTransparency = 1
            container.ZIndex = 6
            local layout = Instance.new("UIListLayout", container)
            layout.Padding = UDim.new(0, 6)
            layout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
                sFrame.Size = UDim2.new(1, 0, 0, layout.AbsoluteContentSize.Y + 20)
            end)
            ...
            function sector:AddToggle(text, default, callback, flag)
                ...
                function toggle:AddColorpicker(default, callback, flag)
                    local cp = Instance.new("TextButton", tBtn)
                    cp.Size = UDim2.fromOffset(16, 8)
                    cp.Position = UDim2.new(1, -16, 0.5, -4)
                    cp.BackgroundColor3 = default or Color3.new(1,1,1)
                    cp.BorderSizePixel = 1
                    cp.BorderColor3 = library.theme.border
                    cp.Text = ""
                    cp.ZIndex = 9
                ...
                function toggle:AddKeybind(default, callback, flag)
                    local kb = Instance.new("TextButton", tBtn)
                    kb.Size = UDim2.fromOffset(40, 14)
                    kb.Position = UDim2.new(1, -40, 0.5, -7)
                    kb.BackgroundTransparency = 1
                    kb.Text = "[" .. (default and default.Name or "None") .. "]"
                    kb.TextColor3 = library.theme.text_dark
                    kb.Font = library.theme.font
                    kb.TextSize = 11
                    kb.ZIndex = 9
                end
            ...
            function sector:AddSlider(text, min, default, max, prec, callback, flag)
                ...
                sLabel.Size = UDim2.new(1, -30, 0, 14)
                sLabel.Text = text ; sLabel.TextColor3 = library.theme.text ; sLabel.BackgroundTransparency = 1
                sLabel.Font = library.theme.font ; sLabel.TextSize = 13 ; sLabel.TextXAlignment = Enum.TextXAlignment.Left
                sLabel.ZIndex = 8
                ...
                local function update(val)
                    slider.value = math.clamp(math.floor(val / prec + 0.5) * prec, min, max)
                    fill.Size = UDim2.new((slider.value - min) / (max - min), 0, 1, 0)
                    if callback then callback(slider.value) end
                end

                local minus = Instance.new("TextButton", sFrame)
                minus.Size = UDim2.fromOffset(10, 10) ; minus.Position = UDim2.fromOffset(0, 15)
                minus.Text = "-" ; minus.TextColor3 = library.theme.text_dark ; minus.BackgroundColor3 = library.theme.sector
                minus.BorderSizePixel = 1 ; minus.BorderColor3 = library.theme.border ; minus.ZIndex = 9
                minus.MouseButton1Click:Connect(function() update(slider.value - prec) end)

                local plus = Instance.new("TextButton", sFrame)
                plus.Size = UDim2.fromOffset(10, 10) ; plus.Position = UDim2.new(1, -10, 0, 15)
                plus.Text = "+" ; plus.TextColor3 = library.theme.text_dark ; plus.BackgroundColor3 = library.theme.sector
                plus.BorderSizePixel = 1 ; plus.BorderColor3 = library.theme.border ; plus.ZIndex = 9
                plus.MouseButton1Click:Connect(function() update(slider.value + prec) end)
            ...
            function sector:AddButton(text, callback)
                ...
                b.BackgroundColor3 = library.theme.sector
                b.BorderSizePixel = 1
                b.BorderColor3 = library.theme.border
                b.Text = text
                b.TextColor3 = library.theme.text
                b.Font = library.theme.font
                b.TextSize = 13
                b.ZIndex = 7
